 ...
 * 
 * import org.apache.catalina.servlet4preview.http.HttpServletRequest; import
 ...
 * webRequest.getNativeRequest(); Enumeration<?> enumeration =
 ...
 * if(values != null){ commandMap.put(key, (values.length > 1) ?
 * values:values[0] ); } } return commandMap;
 * 
 * }
 * 
 * }
