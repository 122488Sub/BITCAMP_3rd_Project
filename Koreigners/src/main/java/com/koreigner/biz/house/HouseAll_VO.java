...
public class HouseAll_VO {
	...
	// T_ROOM_INFO
	int build_type, room_type, bulid_layers, floor_layers, floor_type, stay_num_min, deposit, monthly_rent,
			management_expense; 
	...
	public HouseAll_VO(int room_idx, String mem_email, String subject, String do_en, String gu_gun_eup_eng, String address,
			...
			int bad_type, int air_conditioner, int heating, int kitchen_stove, int refrigerator, int laundry, int pet,
			int internet, int wifi, int elevator, int sink, int bathroom, int parking) {
		super();
	...
	public String toString() {
		return "HouseAll_VO [room_idx=" + room_idx + ", mem_email=" + mem_email + ", subject=" + subject + ", do_en="
				...
				+ ", management_expense=" + management_expense + ", available_date=" + available_date + ", closet="
	...
	public String toRoomInfo() {
		return "RoomInfo [room_idx=" + room_idx + ", build_type=" + build_type + ", room_type=" + room_type
				+ ", bulid_layers=" + bulid_layers + ", floor_layers=" + floor_layers + ", floor_type=" + floor_type
				+ ", stay_num_min=" + stay_num_min + ", deposit=" + deposit + ", monthly_rent=" + monthly_rent
