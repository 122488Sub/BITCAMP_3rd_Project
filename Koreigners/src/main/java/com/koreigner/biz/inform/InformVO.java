...
INFO_IP
	...
	public String toString() {
		return "InformVO [info_idx=" + info_idx + ", info_title=" + info_title + ", info_content=" + info_content
				...
				+ ", info_ip=" + info_ip + ", info_board_idx=" + info_board_idx + ", searchCondition=" + searchCondition
				+ ", searchKeyword=" + searchKeyword + ", uploadFile=" + uploadFile + ", begin=" + begin + ", end="
				+ end + "]";
	}
