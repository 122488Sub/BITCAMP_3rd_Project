				     ...
				     <c:when test="${empty house.img_nameList  }">
				     		...
				     		<div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
		                        <div class="carousel-inner" role="listbox">
		                            <div class="carousel-item active"> <img class="d-block w-100" style="height: 500px;" src="resources/img/common/default-placeholder.jpg" alt="First slide"> </div>
		                        </div>
		                        ...
		                        <ol class="carousel-indicators">
		                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
		                                <img class="d-block w-100 img-fluid" style="height: 150px;" src="resources/img/common/default-placeholder.jpg" alt="" />
		                            </li>
		                        </ol>
		                    </div>
				     </c:when>
				     		...
				     		<div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
		                    	...
		                    	<c:forEach items="${house.img_nameList}" varStatus="status" var="img" >
		                    		<c:if test="${status.index ==0}">
		                    			<div class="carousel-item active"> <img class="d-block w-100" style="height: 500px;" src="resources/img/house/upload/${house.mem_email}/${img}" alt="slide${status.index+1}"> </div>
					        		</c:if>
					        		<c:if test="${status.index !=0}">
					        			<div class="carousel-item"> <img class="d-block w-100" style="height: 500px;" src="resources/img/house/upload/${house.mem_email}/${img}" alt="slide${status.index+1}"> </div>
					        		</c:if>
					     		</c:forEach>
		                        </div>
		                        <a class="carousel-control-prev" href="#carousel-example-1" role="button" data-slide="prev"> 
		                        ...
		                        <c:if test="${status.index ==0}">
		                            <li data-target="#carousel-example-1" data-slide-to="${status.index}" class="active">
		                                <img class="d-block w-100 img-fluid" style="height: 150px;" src="resources/img/house/upload/${house.mem_email}/${img}" alt="" />
		                            </li>
		                        </c:if>
		                        <c:if test="${status.index !=0}">
