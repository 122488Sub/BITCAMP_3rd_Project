...
<br><br><br>
	...
	<div id="rsWriteContent">
		...
		<form action="resalePost.do" method="post"
			...
			<div id="imgBox">
				<label>사진 : </label>
				<div id="defaultImg">
					<img src="images/default-placeholder2.png" width="200px"
						height="200px">
				</div>
			...
			<br>
			<br> <label>제목 : </label> <input type="text" name="subject"
				placeholder="제목을 입력하세요." title="제목"> <br>
			<br>
			<br>
			...
			<br> <label>설명 : &nbsp;</label>
			<textarea id="contentBox" name="content"
				placeholder="제품에 대한 설명을 입력하세요." rows="10" title="설명"></textarea>
			<br>
			<br>
			<br>
			<hr color="#3e64ff;">
			...
			<br> <label>해시태그 : &nbsp;</label> <input type="text"
				name="hash_tag" placeholder="최대 5개 입력 가능합니다." title="해시태그">
			<br>
			<br>
			<br>
			<hr color="#3e64ff;">
			...
			<br> <input type="hidden" id="hiddenCate1" name="rs_cate_prnt"
				title="카테고리"> <input type="hidden" id="hiddenCate2"
				name="category_child" title="하위 카테고리"> <input type="button"
				value="등록하기" id="btn" onclick="sendData()">
		</form>
	</div>
