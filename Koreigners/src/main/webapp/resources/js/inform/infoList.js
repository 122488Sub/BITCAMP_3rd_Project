...
if(wishBool==1){	
	gridHtml+=     				'<li><a href="javascript:clickWishGrid('+"'"+$('#mem_id').val()+"'"+','+inform.INFO_IDX+',4)" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i id="wish_'+inform.INFO_IDX+'" class="fas fa-heart"></i></a></li>';
}else{
